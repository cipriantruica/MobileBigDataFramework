...
/*
    ...
    It doesn't compress the output
*/

object OneMergedFileDFSelect {
  def main(args: Array[String]): Unit = {
        ...
        val printFile = "/home/ciprian/mergetime_df_select.txt" 
        ...
        df.select(from_unixtime(df("Timestamp")/1000, "yyyy-MM-dd hh:mm:ss").as("Timestramp"), df("SquareID1"), df("SquareID2"), df("DIS"))
            ...
            .option("codec", "none") // if you need compression, use one of bzip2, deflate, uncompressed, lz4, gzip, snappy, none - snappy by deault
            // .text(outputFile)
            .save(outputFile)
