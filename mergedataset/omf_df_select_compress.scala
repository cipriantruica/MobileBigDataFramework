...
/*
    ...
    It do compress the output using snappy compression algorithm
*/

object OneMergedFileDFSelectCompressed {
  def main(args: Array[String]): Unit = {
        ...
        val printFile = "/home/ciprian/mergetime_df_select_compress.txt" 
