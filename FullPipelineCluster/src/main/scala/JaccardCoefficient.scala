...
object JaccardCoefficient {
  def main(args: Array[String]): Unit = {
    ...
    val query_jc = "select d1.MilanoDate, d1.SID1, d2.SID2, d1.sum_mins/d2.sum_maxs jaccard_coefficient from (" + query_min2 + ") d1 inner join (" + query_max2 + ") d2 on d1.SID1 = d2.SID1 and d1.SID2 = d2.SID2 and d1.MilanoDate = d2.MilanoDate"
